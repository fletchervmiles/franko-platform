...
export default function DemoStartInterviewPage() {
  const searchParams = useSearchParams()
  const router = useRouter()
  const clientId = "user_demo_account"
  ...
  return (
    <>
      <div className="flex flex-1 flex-col gap-4 p-2 md:p-4 bg-gray-100/75 min-h-screen relative">
