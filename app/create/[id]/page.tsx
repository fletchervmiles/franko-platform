...
export default async function CreatePage({ params, searchParams }: { params: { id: string }, searchParams: { regenerate?: string, type?: string } }) {
  ...
  // Check if a specific template type was requested
  const templateType = searchParams.type || null
      ...
      <div className="h-full p-4 md:p-8 lg:p-12">
        <div className="w-full">
          <h1 className="text-2xl font-semibold mb-2">
            {isRegenerating ? "Regenerate Conversation Plan" : "Create a new Interview Agent"}
          </h1>
          <p className="text-gray-600 mb-8">
          Each agent is instructed with a unique plan which provides learning objectives, guiding your agent during conversations.
          </p>
