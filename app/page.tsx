      ...
      <section className="py-24 md:py-32 bg-black text-white grid-background03-dark">
        <div className="w-full max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 md:mb-24">
            ...
            Automate short, targeted conversations at critical points in your customer journey—each conversation accessed by your customers via simple, shareable links.
            </p>
          </div>
          <Timeline />
        </div>
