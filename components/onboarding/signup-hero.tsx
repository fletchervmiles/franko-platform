...
export default function SignupHero() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex justify-center p-4 sm:p-8 lg:p-12 xl:p-16 overflow-y-auto">
      <div className="container mx-auto w-full lg:flex lg:items-center lg:min-h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center py-4 sm:py-8 lg:py-12">
            ...
            {step === 'email' && (
              <div className="w-full max-w-lg space-y-4 sm:space-y-6">
                {/* Mobile-first approach for the form */}
                <div className="block sm:hidden">
                  <form onSubmit={handleEmailSubmit} className="space-y-3">
                    <Input
                      ...
                      className="bg-[#2121210F] border-gray-300 focus:ring-2 focus:ring-[#E4F222]/80 focus:border-[#E4F222] text-gray-900 placeholder-gray-500 h-12 px-4 rounded-lg w-full text-base"
                      required
                    />
                    <Button
                      type="submit"
                      className="bg-[#E4F222] text-black hover:bg-[#F5FF78] active:bg-[#F5FF78] font-semibold rounded-md h-12 text-sm w-full"
                    >
                      Get started for free
                    </Button>
                  </form>
            ...
            {step === 'details' && (
              <div className="w-full max-w-lg space-y-4 sm:space-y-6">
                <div className="mb-4">
                  <h2 className="text-lg sm:text-xl font-semibold mb-2">Complete your account</h2>
          ...
          <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="bg-gradient-to-b from-[#E0F2FE] to-[#FFFFFF] rounded-xl shadow-2xl overflow-hidden w-full max-w-sm py-6 sm:py-10">
              <div className="bg-[#F4F2F0] rounded-full mx-auto mt-4 sm:mt-6 mb-4 w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] flex items-center justify-center">
                <Image
                  src="/assets/ben02.jpg"
                  alt="Ben Goodman Portrait"
                  width={200}
                  height={200}
                  className="rounded-full object-cover w-[150px] h-[150px] sm:w-[200px] sm:h-[200px]"
                />
              </div>
              <div className="p-4 sm:p-6 text-[#0C0A08]">
                <blockquote className="text-sm sm:text-base md:text-md mb-4 leading-relaxed text-[#0C0A08]">
