...
>(({ className, children, ...props }, ref) => (
  <AccordionHeaderPrimitive className="flex">
    <AccordionTriggerPrimitive
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 font-medium transition-all hover:underline [&[data-state=open]_.chevron-wrapper>svg]:rotate-180",
        className
      )}
      {...props}
    >
      {children}
      <div className="chevron-wrapper flex h-7 w-7 items-center justify-center rounded-md border border-gray-200">
