...
//             <div className="p-4 bg-amber-50 border border-amber-200 text-amber-800 rounded-md text-sm flex items-start gap-2 mb-4">
//               <AlertTriangle className="h-5 w-5 text-amber-500 flex-shrink-0 mt-0.5" />
//               <div>
//                 <p className="font-medium">Q&A Message Quota Exceeded</p>
//                 <p>You've reached your limit for Q&A messages. Please upgrade your plan for additional capacity.</p>
//               </div>
//             </div>
//           )}
...
//           {!isQuotaLoading && !hasAvailableQAQuota ? (
//             <div className="p-3 bg-gray-100 rounded-md text-gray-500 text-sm flex items-center justify-center border border-gray-200">
//               <AlertTriangle className="h-4 w-4 mr-2 text-amber-500" />
//               Q&A message quota exceeded. Please upgrade your plan to continue.
//             </div>
//           ) : (
//             <ChatInput
//               value={input}
...
//               disabled={isLoading || (!isQuotaLoading && !hasAvailableQAQuota)}
//               stop={stop}
