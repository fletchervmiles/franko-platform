          ...
          <Link href="/" className="flex items-center">
            {scrolled ? (
              <div className="w-8 h-8">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/franko-logo-icon-O8sR7V0dXkGqrfCIn7HhXjVfEplGMX.png"
                  alt="Franko Logo"
                  width={32}
                  height={32}
                  priority
              ...
              <div className="h-6">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/text-logo-big-sE32xntSStEdcgPgIkRGdbvqFPgEaB.png"
                  alt="Franko"
                  width={100}
                  height={24}
                  priority
